 ...
 if(isset($_POST['enviar'])) { // comprobamos que se han enviado los datos desde el formulario
    ...
    if(!empty($sin_espacios[32])) { // comprobamos que el campo usuario_nombre no tenga espacios en blanco
        ...
        if(mysql_num_rows($sql) > 0) {
            ...
            echo "<h1><b> Error al registrar usuario </b></h1><br>";
            echo "<h3>El email ya ha sido registrado anteriormente. <a href='javascript:history.back();'>Reintentar</a>";
            echo "<center><br><hr><h3><br>Ir a <b><a href='index.php'>Inicio</a></b></h3></center>";
        }
        else {
            ...
            if($reg) {
                ...
                echo "<h1><b> Error al registrar usuario </b></h1><br>";
                echo "<h3>Ha ocurrido un error durante el proceso de registro. No se registraron los datos.  <a href='javascript:history.back();'>Reintentar</a>";
                echo "<center><br><hr><h3><br>Ir a <b><a href='index.php'>Inicio</a></b></h3></center>";
            }
        }
    }
